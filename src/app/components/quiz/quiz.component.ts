...
import { answered } from 'src/app/animations';
...
export class QuizComponent implements OnInit {
  ...
  selectAnswers(rightAnswer: ContinentNames) {
    if (!this.currentAnswers) {
      ...
      this.currentAnswers = this.shuffle(answers);
  ...
  submitAnswer(isRight: boolean, answerSelected: ContinentNames) {
